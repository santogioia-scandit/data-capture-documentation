  ...
  return (
    <header className={style.header}>
      ...
      <div className={style.authBtns}>
        <Link className={style.btnLogin} to="https://ssl.scandit.com/dashboard/sign-in?p=test">
          Log In
        </Link>
        <Link className={style.btnSignUp} to="https://www.scandit.com/trial/">Sign Up</Link>
      </div>
    </header>
  );
}
