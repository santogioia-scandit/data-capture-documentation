...
export default function DataCapture() {
  return (
    <div className={style.dataCapture}>
      ...
      <p className={style.dataCaptureText}>Learn about the core concepts used throughout the Scandit Data Capture SDK and the full suite of available features and functionalities.
      </p>
