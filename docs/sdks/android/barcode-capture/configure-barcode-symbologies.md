...
- [Add the SDK to Your App](https://docs.scandit.com/data-capture-sdk/android/add-sdk.html)
- [Get Started With Barcode Capture](https://docs.scandit.com/data-capture-sdk/android/get-started-barcode.html)
- [Barcode Symbologies](https://docs.scandit.com/data-capture-sdk/android/barcode-symbologies.html)
...
When you enable a symbology as described above, only dark-on-bright codes are enabled (see [SymbologySettings.isEnabled]). When you also want to read bright-on-dark codes, color-inverted reading for that symbology must also be enabled (see [SymbologySettings.isColorInvertedEnabled]).
