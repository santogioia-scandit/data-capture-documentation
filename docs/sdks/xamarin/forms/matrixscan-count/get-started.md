...
:::note
When subscribing to view events you should wait for the [BarcodeCountView.ViewInitialized](barcode-capture/api/ui/barcode-count-view.html#property-scandit.datacapture.barcode.count.ui.BarcodeCountView.ViewInitialized) event to occure.
:::
